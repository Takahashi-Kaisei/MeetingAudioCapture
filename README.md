...
5. `録音停止` を選ぶと、選択した保存先に選択形式の音声ファイルが保存されます。
...
Codex側ではビルド、単体テスト、M4A/WAV/MP3分割保存のテストまでを確認します。実際のZoom/Discord/Google Meet/Teamsや対面録音で相手音声と自分の声が保存されるかは、ユーザー実機で確認してください。
